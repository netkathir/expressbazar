...
@section('content')
    ...
    <main class="sf-page">
        <section class="container-fluid px-3 px-lg-4 py-4">
            <nav class="sf-breadcrumbs">Home <span>›</span> Checkout <span>›</span> Success</nav>

            <div class="sf-info-card text-center py-5">
                <div class="mb-3">
                    <span class="badge rounded-pill text-bg-success px-3 py-2">Order Placed</span>
                </div>
                <h1 class="h2 fw-bold mb-2">Your order has been placed successfully</h1>
                <p class="text-secondary mb-4">
                    Order number <strong>{{ $order->order_number }}</strong> is now pending processing.
                </p>
                ...
                <div class="sf-detail-grid mb-4">
                    ...
                    <div class="sf-info-card text-start">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <div class="sf-coupon-row"><span>Retry payment later if needed</span><i class="ti ti-chevron-right"></i></div>
