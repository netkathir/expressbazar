    ...
    <div class="card shell-card mb-4">
        <div class="card-body p-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                ...
                <p class="text-secondary mb-0">Control delivery rules and zone-specific charges.</p>
            </div>
                ...
                <tbody>
                    @forelse ($configs as $config)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.delivery.edit', $config) }}" class="btn btn-sm btn-outline-primary">Edit</a>
